...
The design is inspired by a Figma Community project that replicates [Adobe Spectrum v2](https://spectrum.adobe.com/) using modern frontend tools.
...
- **React Testing Library**  
  A user-centric testing approach that focuses on the behavior of components rather than implementation details.
